    ...
    <modal name="register" transition="pop-out" :width="modalWidth" height="auto">
        ...
        <form method="POST" action="register" class="bg-white shadow-md rounded-b-lg px-8 pt-6 pb-8">
            ...
            <div class="mb-4">
                ...
                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="name" name="name" type="text" placeholder="Name" :value="name" required>
            </div>
            <div class="mb-4">
