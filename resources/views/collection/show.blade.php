...
@section('content')
    ...
    <h2 class="text-3xl border-b mb-4">Add To Collection</h2>
        ...
        <button type="submit" class="mt-5 border rounded p-2 text-center bg-blue-400 text-white">Add To Collection</button>
    </form>

    <h2 class="text-3xl border-b mt-5 mb-4">Manage Collection</h2>
        ...
        <div class="flex">
            ...
            <div class="flex justify-end ml-4">
                <form method="POST" action="{{ route('collection.delete', ['collection' => $stampInCollection]) }}">
                    @csrf
                    @method('DELETE')
                    <button type="submit" class="border rounded p-2 text-center w-full bg-red-400 text-white">
