...
@section('content')
    ...
    {{-- Features --}}
    <div id="features" class="flex-grow container mx-auto my-8 flex justify-between">
        <div class="mr-2 flex-1">
            <img src="{{ asset('images/mystamps.png') }}" alt="MyStamps" />
        </div>
        <div class="flex flex-col justify-around ml-2 flex-1 text-lg">
            <div class="flex items-center mb-4">
                <svg class="fill-current" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 20 20">
