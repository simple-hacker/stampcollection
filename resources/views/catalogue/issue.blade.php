                        ...
                        <div class="flex flex-col items-stretch">
                            ...
                            @can('update issue')
                                ...
                                <form method="POST" action="{{ route('issue.delete', ['issue' => $issue]) }}" onsubmit="return confirm('Are you sure you want to delete this issue?')">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="flex bg-red-500 hover:bg-red-600 text-white border rounded px-4 py-2 w-full">
                            ...
                            <template v-slot:dropdown-contents>
                                <div class="flex flex-col items-stretch w-full">
                                    @can('update stamp')
                                        ...
                                        <form method="POST" action="{{ route('stamp.delete', ['stamp' => $stamp]) }}" onsubmit="return confirm('Are you sure you want to delete this stamp?')" class="w-full">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="flex bg-red-500 hover:bg-red-600 text-white border rounded px-4 py-2 w-full">
                                                <svg class="fill-current mr-2" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
